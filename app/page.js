  ...
  return (
    ...
    <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }}   className=' absolute top-16 right-[5%] z-10 ml-8'>
      ...
      <main className='flex relative flex-col items-center justify-between  overflow-x-hidden overflow-y-visible h-[850px]'>
        ...
        <motion.div whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: -200}} transition={{ duration: 1 }} className=" absolute top-60 left-[10%] w-[250px] h-[180px] text-grey-100 p-3 rounded-lg text-center flex flex-col justify-center items-center text-gray-800">
          <p className={`${wg.className} text-6xl text-start w-full`}>Ерлан</p>
          <p className={`${wg.className} text-6xl`}>&</p>
          <p className={`${wg.className} text-6xl text-end w-full`}>Нyргyль</p>
        </motion.div>
        <br />
        <br />
      ...
      <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} transition={{ duration: 1 }} className='w-[80%] font-bold mx-auto text-center relative mb-[170px] border-[#96825f] border-[1px] '>
        <i>
          <p className={`text-xl mt-6 m-0 absolute top-0 right-20`}>Eрлан мен Нургуль</p>
      ...
      <p className=' font-bold text-xl'>22.11.2025 | 17:00 | Сейсенбі</p>
      </motion.div>
      ...
      <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 100 }} exit={{ opacity: 0, y: -100 }} transition={{ duration: 1 }} className=' flex flex-col w-[80%] mx-auto mb-[100px] ] p-4 rounded-lg relative overflow-hidden right-0 justify-center items-center text-lg '>
        ...
        <p className=' text-lg font-extrabold'>Шығыс жұлдызы мейрамханасы</p>
        <p className=' text-lg font-extrabold'>Темирбек Жургенов, 18/2</p>
      </motion.div>
